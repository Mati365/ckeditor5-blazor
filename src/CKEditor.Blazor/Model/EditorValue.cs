...
public sealed record EditorValue
{
    ...
    public EditorValue(string? value) => _roots = new Dictionary<string, string> { { "main", value ?? string.Empty } };
    ...
    public EditorValue(Dictionary<string, string>? roots) => _roots = roots ?? [];
    ...
    public static implicit operator EditorValue(string? value) => new(value);
    ...
    public static implicit operator EditorValue(Dictionary<string, string>? value) => new(value);
}
