...
public class CloudLicenseIncompatibleExceptionTests
{
    [Fact]
    public void Constructor_WithMessage_ShouldSetMessageProperty()
    {
        var message = "Test exception message";
        var exception = new CloudLicenseIncompatibleException(message);
    ...
    public void Constructor_WithMessageAndInnerException_ShouldSetProperties()
    {
        ...
        var exception = new CloudLicenseIncompatibleException(message, innerException);
